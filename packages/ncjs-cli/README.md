...
ncjs-cli/1.4.2 linux-x64 node-v13.12.0
...
_See code: [src/commands/bech32.js](https://github.com/VeriBlock/nodecore-js/blob/v1.4.2/src/commands/bech32.js)_
...
_See code: [src/commands/decode.js](https://github.com/VeriBlock/nodecore-js/blob/v1.4.2/src/commands/decode.js)_
...
_See code: [src/commands/dumppublications.js](https://github.com/VeriBlock/nodecore-js/blob/v1.4.2/src/commands/dumppublications.js)_
...
_See code: [src/commands/printcontext.js](https://github.com/VeriBlock/nodecore-js/blob/v1.4.2/src/commands/printcontext.js)_
<!-- commandsstop -->
